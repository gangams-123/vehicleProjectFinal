...
export class Officials {
 ...
 this.designationService.getDesignationByDept(deptId).subscribe((res: any) => {
  ...
  onCountryChange(type:'permanent'|'present',event:any){
    console.log('Check permanent group:', this.officialForm.get('Address.permanent'));
  console.log('Check selCountry control:', this.officialForm.get('Address.permanent.selCountry'));
