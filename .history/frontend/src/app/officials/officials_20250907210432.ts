...
if (formValue.addresses?.permanent) 
  formValue.addresses.permanent.addressType = 'permanent';
if (formValue.addresses?.present) 
  formValue.addresses.present.addressType = 'present';
...
console.log(JSON.stringify(formValue.addresses));
  ...
  const addressesArray = [
    formValue.addresses.permanent,
    formValue.addresses.present
  ];

  // Append as JSON

  formData.append('addresses', JSON.stringify(formValue.addresses));
    //append files
